...
| `backup_truenas_vms` | `false` | Include encrypted TrueNAS VM definitions, devices and UEFI/TPM firmware files; requires SSH, an external recovery key and stopped TPM guests |
